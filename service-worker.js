// Service worker for TJC Service Flow Automator extension
// Handles Google Sheet htmlview fetching to discover tabs and fetches individual CSV data
// Also acts as a proxy for H2R Graphics HTTP POST requests to bypass HTTPS Mixed Content restrictions
